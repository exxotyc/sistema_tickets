...
class CommentSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        content_value = validated_data.pop("content", "")
        obj = Comment(**validated_data)
        obj.body = content_value
        obj.save()
        return obj
...
# ==========================================================
# ==========================================================
#   TICKET SERIALIZER (CORREGIDO PARA PRIORITY FK)
# ==========================================================
...
class TicketSerializer(serializers.ModelSerializer):
    ...
    # ------------------------------------------------------
    #   UPDATE — REASIGNACIÓN Y PROTECCIÓN DE CAMPOS
    # ------------------------------------------------------
    ...
    def update(self, instance, validated_data):
        ...
        # --- Restricciones para solicitante ---
        if user and user.groups.filter(name="solicitante").exists():
            restricted = {"priority", "category", "assigned_to"}
